    ...
    var Fg = Object.freeze({
        ...
        inject: function (len, ptr) {
            try {
                ...
                const data = appendJsonToMemory(JSON.stringify(fp_json_curr) + `akAs","src","stopCo`);
