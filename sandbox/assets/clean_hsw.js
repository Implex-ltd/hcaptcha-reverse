...
var hsw = function () {
		...
		var Q = {
			...
			C = function () {
				...
				try {
					...
					//console.log(B) // .memories.$memory.buffer
	...
	*/
	var yI = Object.freeze({
		__proto__: null,
		fuckthebreakpoint: function () {
			console.log('CALL FROM WASM')
			try {
				const uint8Array = new Uint8Array(M.memory.buffer);
	...
	var YI, FI, sI = !1,
		kI = (YI = function (A, g, I, B) {
			...
			return Q(C, B, !1)
		}(0, null, b64wasm, FI), new Promise((function (A, g) {
			YI.then((function (A) {
				return function (A, g) {
					return new Promise((function (I, B) {
						WebAssembly.instantiate(A, g).then((function (wasm) {
							wasm instanceof WebAssembly.Instance ? I({
								instance: wasm,
								module: A
							}) : I(wasm)
						})).catch((function (A) {
